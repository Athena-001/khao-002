...
class _Product_rowState extends State<Product_row> {
  ...
  Widget build(BuildContext context) {
    switch (widget.nutriscore) {
      case 'a':
        categoryIcon = Container(
            width: 75, height: 75, child: Image.asset('assets/nutri_a.png'));
        break;

      case 'b':
        categoryIcon = Container(
            width: 75, height: 75, child: Image.asset('assets/nutri_b.png'));
        break;

      case 'c':
        categoryIcon = Container(
            width: 75, height: 75, child: Image.asset('assets/nutri_c.png'));
        break;

      case 'd':
        categoryIcon = Container(
            width: 75, height: 75, child: Image.asset('assets/nutri_d.png'));
        break;

      case 'e':
        categoryIcon = Container(
            width: 75, height: 75, child: Image.asset('assets/nutri_e.png'));
        break;
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushReplacementNamed(context, '/product_history',
